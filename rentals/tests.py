...
class RentalAPIAdditionalTests(APITestCase):
    ...
    def test_create_rental_ignores_readonly_fields_from_client(self):
        """user / status / price_per_day не повинні підмінюватись клієнтом."""
        res = self.create_rental(
        ...
        self.assertEqual(rental.price_per_day, self.car.daily_rate)
